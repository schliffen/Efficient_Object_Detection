...
class YOLO(object):
    def __init__(self, backend,
        ...
        if backend == 'Inception3':
            ...
            self.feature_extractor = SqueezeNetFeature(self.input_size, training=self.training )
        ...
        output_01 = Conv2D(self.nb_box * (4 + 1 + self.nb_class),
                        (1,1), strides=(1,1), 
                        padding='same', 
                        name='DetectionLayer', 
                        kernel_initializer='lecun_normal')(features)
        output_02 = Reshape((self.grid_h, self.grid_w, self.nb_box, 4 + 1 + self.nb_class))(output_01)
    ...
    def train(self, train_imgs,     # the list of images to train the model
                    ...
                    coord_scale,
                    class_scale,
                    saved_weights_name='./results/best_weights.h5',
                    saved_tb_logs = './results/tensorboard/',
                    debug=False):     
        ...
        checkpoint = ModelCheckpoint(saved_weights_name, 
                                     ...
                                     mode='min', 
                                     period=1)
        tensorboard = TensorBoard(log_dir=os.path.expanduser(saved_tb_logs),
                                  histogram_freq=0, 
