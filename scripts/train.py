...
import sys, os, glob
sys.path.append('/home/ali/CLionProjects/object_detection/SqueezeDet/squeezedet/')
...
print( 'number of gpus: ',  device_lib.list_local_devices())
# tensorflow 2 command
...
#
# Adding path
scrpt_path = os.path.split(os.path.realpath(__file__))[0]
# get current path
root_path = '/'.join(scrpt_path.split('/')[:-1]) + '/'
sys.path.append( root_path )
sys.path.append( root_path + 'main' )
# img_file = "img_train.txt"
lbl_files = "/home/rapsodo/BASKETBALL/00_DATASETS/Kitti_Object_Detection/training/label_2/" # path to the labels
img_files = "/home/rapsodo/BASKETBALL/00_DATASETS/Kitti_Object_Detection/data_object_image_2/training/image_2/"
log_dir_name = root_path + 'log'
init_file = root_path + "experiments/imagenet.h5"
EPOCHS = 10
STEPS = None
OPTIMIZER = "default"
...
CONFIG = root_path + "main/config/squeeze_01.config"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img",
                        default="/home/rapsodo/BASKETBALL/00_DATASETS/Kitti_Object_Detection/data_object_image_2/training/image_2/",
                        help="file of full path names for the training images. DEFAULT: img_train.txt")
    parser.add_argument("--gt",
                        default="/home/rapsodo/BASKETBALL/00_DATASETS/Kitti_Object_Detection/training/label_2/",
