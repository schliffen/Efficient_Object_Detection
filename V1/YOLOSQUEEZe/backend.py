...
TrainedModelPath = '/home/ali/CLionProjects/object_detection/SqueezeDet/squeezedet/pretrained_models/pretrained/'

FULL_YOLO_BACKEND_PATH  = TrainedModelPath + "full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = TrainedModelPath + "tiny_yolo_backend.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = TrainedModelPath + "squeezenet_backend.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = TrainedModelPath + "mobilenet_backend.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = TrainedModelPath + "inception_backend.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = TrainedModelPath + "vgg16_backend.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = TrainedModelPath + "resnet50_backend.h5"    # should be hosted on a server
...
class SqueezeNetFeature(BaseFeatureExtractor):
    """docstring for ClassName"""
    def __init__(self, input_size, training = True):
